...
<table>
	...
	<tr class="row">
		...
		<td class="col"> <?php echo e($val->original_price); ?> </td>
		<td class="col"> <?php echo e($val->regular_price); ?> </td>
		<td class="col"> <?php echo e($val->sale_price); ?> </td>
		<td class="col"> <?php echo e($val->weight); ?> </td>
	</tr>

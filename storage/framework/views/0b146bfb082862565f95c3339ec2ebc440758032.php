...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="<?php echo e(route('admin.wms_import.store',['type'=>$type])); ?>" class="form-validation">
                ...
                <div class="portlet-body">
                    <div class="form-group">
                        <div class="input-group select2-bootstrap-append">
                            <select id="select2-button-addons-single-input-group-sm" class="form-control select2-data-ajax"  multiple="" data-label="Mã sản phẩm" data-url="<?php echo e(route('admin.product.ajax',['type'=>'san-pham'])); ?>">
                            </select>

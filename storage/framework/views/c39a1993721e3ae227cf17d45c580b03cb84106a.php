...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="<?php echo e(route('admin.link.update',['id'=>$item->id,'type'=>$type])); ?>" enctype="multipart/form-data" >
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[facebook]" class="form-control" value="<?php echo e($item->facebook); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[skype]" class="form-control" value="<?php echo e($item->skype); ?>">
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[youtube]" class="form-control" value="<?php echo e($item->youtube); ?>">
                        </div>
                    </div>
                    <?php endif; ?>

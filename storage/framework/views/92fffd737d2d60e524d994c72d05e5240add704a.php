	...
	<div class="col-md-12">
		<div class="portlet box green">
			<div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo e(route('admin.wms_import.create',['type'=>$type])); ?>" class="btn btn-sm btn-default"> Thêm mới </a>
					...
					<table class="table table-bordered table-condensed">
						...
						<tbody>
                            ...
                            <tr id="record-<?php echo e($item->id); ?>">
                                ...
                                <td align="center"> <input type="text" name="priority" class="form-control input-mini input-priority" value="<?php echo e($item->priority); ?>" data-ajax="act=update_priority|table=wms_imports|id=<?php echo e($item->id); ?>|col=priority"> </td>
                                ...
                                <td align="center">
                                    <a href="<?php echo e(route('admin.wms_import.edit',['id'=>$item->id, 'type'=>$type])); ?>" data-target="#barcode-modal" data-toggle="modal" class="btn btn-sm green" title="Mã vạch"> <i class="fa fa-barcode"></i> </a>
                                    <a href="<?php echo e(route('admin.wms_import.edit',['id'=>$item->id, 'type'=>$type])); ?>" class="btn btn-sm blue" title="Chỉnh sửa"> <i class="fa fa-edit"></i> </a>
                                    <?php if($item->status == 'publish'): ?>
                                    <a href="#" data-target="#cancel-modal" data-toggle="modal" data-url="<?php echo e(route('admin.wms_import.delete',['id'=>$item->id, 'type'=>$type])); ?>" class="btn btn-sm btn-cancel red" title="Hủy phiếu"> <i class="fa fa-ban"></i> </a>
                                    <?php endif; ?>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <img src="<?php echo e(asset('public/images/loading-spinner-grey.gif')); ?>" alt="" class="loading">
                <span> &nbsp;&nbsp;Loading... </span>
            </div>
        </div>
    </div>

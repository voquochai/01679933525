                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="shipping" class="form-control priceFormat" value="<?php echo e($item->shipping); ?>">
                            <span class="input-group-addon"> VNĐ </span>
                        </div>
                    </div>

                    <?php if($item->coupon_amount > 0): ?>
                    <div class="form-group">
                        <label class="control-label">Giảm giá</label>
                        <div class="input-group">
                            <input type="text" class="form-control priceFormat" value="<?php echo e($item->coupon_amount); ?>" disabled>
                            <span class="input-group-addon"> VNĐ </span>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="total" class="form-control priceFormat" value="<?php echo e($item->total); ?>" disabled>
                            <span class="input-group-addon"> VNĐ </span>
                        </div>
                    </div>

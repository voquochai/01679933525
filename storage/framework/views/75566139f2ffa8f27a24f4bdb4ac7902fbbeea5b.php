...
<li>
    <a href="<?php echo e(route('admin.role.index')); ?>"> Chức năng </a>
...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="<?php echo e(route('admin.role.update',['id'=>$item->id])); ?>" enctype="multipart/form-data" >

...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo e(__('cart.your_order')); ?></h3>
    </div>
    <div class="panel-body">
            ...
            <table class="table table-bordered table-condensed">
                ...
                <tbody>
                    ...
                    <tr id="record-<?php echo e($item->id); ?>">
                        ...
                        <td align="center"><a href="<?php echo e(route('frontend.member.order',['id'=>$item->id])); ?>"><?php echo e($item->code); ?></a></td>
        ...
        <div class="text-center"> <?php echo e($items->links('frontend.default.layouts.paginate')); ?> </div>
    </div>
</div>

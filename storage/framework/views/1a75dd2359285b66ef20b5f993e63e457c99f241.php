					...
					<table class="table table-bordered table-condensed">
						...
						<tbody>
                            ...
                            <tr id="record-<?php echo e($item->id); ?>">
                                ...
                                <td align="center"> <?php echo e(number_format($item->coupon_amount,0,',','.') . ($item->change_conditions_type == 'percentage_discount_from_total_cart' ? '%': '')); ?> </td>
                                <td align="center"> <?php echo e($item->number_of_uses); ?> </td>
                                <td align="center"> <?php echo e(number_format($item->min_restriction_amount,0,',','.').' - '.number_format($item->max_restriction_amount,0,',','.')); ?> </td>

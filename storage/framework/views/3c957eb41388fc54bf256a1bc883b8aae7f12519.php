    ...
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu page-header-fixed page-sidebar-menu-light" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.category.index',['type'=>'tin-tuc'])); ?>" data-route="category.tin-tuc" class="nav-link ">
                            <span class="title"> Danh mục</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.post.index',['type'=>'tin-tuc'])); ?>" data-route="post.tin-tuc" class="nav-link ">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.post.index',['type'=>'khach-hang'])); ?>" data-route="post.khach-hang" class="nav-link ">

...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="<?php echo e(route('admin.user.update',['id'=>$item->id])); ?>" >
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[username]" class="form-control" value="<?php echo e($item->username); ?>">
                        </div>
                    </div>
                    <div class="form-group">

            ...
            <div class="col-lg-9 col-md-8 col-xs-12">
                ...
                <div class="single-blog-post">
                    ...
                    <div class="blog-info">
                        ...
                        <div class="blog-meta">
                            <span><a href="#"><i class="fa fa-user"></i> <?php echo e($author); ?> </a></span>
                            <span><a href="#"><i class="fa fa-tags"></i> <?php echo e($category); ?> </a></span>
                            <span><a href="#"><i class="fa fa-comments"></i> 4 Comments</a></span>
                            <span><a href="#"><i class="fa fa-eye"></i> views (<?php echo e($post->viewed+1); ?>)</a></span>
                        </div>

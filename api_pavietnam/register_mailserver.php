<?php
	...
	$struct = array(
			'cmd' 				=> 'register_mailserver',//Lệnh đăng ký mail server			
			'username'			=> USERNAME,//Username đại lý
			'apikey'			=> API_KEY,//API KEY
			'hosting'			=> '30944',//ID gói mail server (Dùng lệnh mailserver_list để xem danh sách ID các gói mail server)
			'domain' 			=> 'mailserver.com',//Tên miền
			'amount' 			=> '1',//Số lượng đăng ký:  [số lượng 2] x [chọn gói 6 tháng] = [đăng ký 12 tháng] 
			'pwd'				=> 'BTVM1478edhp',//Password từ 8 đến 16 ký tự và phải bao gồm các ký tự chữ Hoa (A-Z), chữ Thường (a-z) và Số (0-9)

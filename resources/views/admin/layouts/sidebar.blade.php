    ...
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu page-header-fixed page-sidebar-menu-light" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    <li class="nav-item">
                        <a href="{{ route('admin.category.index',['type'=>'san-pham']) }}" data-route="category.san-pham" class="nav-link ">
                            <span class="title"> Danh mục </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.product.index',['type'=>'san-pham']) }}" data-route="product.san-pham" class="nav-link ">
                            <span class="title"> Sản phẩm </span>
                        </a>
                    </li>
                    {{--
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.attribute.index',['type'=>'product_sizes']) }}" data-route="attribute.product_sizes" class="nav-link ">
                            <span class="title"> Kích cỡ </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.attribute.index',['type'=>'product_tags']) }}" data-route="attribute.product_tags" class="nav-link ">
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.post.index',['type'=>'payment']) }}" data-route="post.payment" class="nav-link ">
                            <span class="title"> Hình thức thanh toán </span>
                        </a>
                    </li>
                    {{--
                    <li class="nav-item">
                        <a href="{{ route('admin.attribute.index',['type'=>'post_tags']) }}" data-route="attribute.post_tags" class="nav-link ">
                            <span class="title"> Thẻ </span>
                        </a>
                    </li>
                    --}}
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    <li class="nav-item">
                        <a href="{{ route('admin.page.index',['type'=>'index']) }}" data-route="page.index" class="nav-link ">
                            <span class="title"> Trang chủ </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.page.index',['type'=>'gioi-thieu']) }}" data-route="page.gioi-thieu" class="nav-link ">
                            <span class="title"> Giới thiệu </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.page.index',['type'=>'tuyen-dung']) }}" data-route="page.tuyen-dung" class="nav-link ">
                            <span class="title"> Tuyển dụng </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.page.index',['type'=>'lien-he']) }}" data-route="page.lien-he" class="nav-link ">
                            <span class="title"> Liên hệ </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.page.index',['type'=>'footer']) }}" data-route="page.footer" class="nav-link ">
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    <li class="nav-item">
                        <a href="{{ route('admin.photo.index',['type'=>'slideshow']) }}" data-route="photo.slideshow" class="nav-link ">
                            <span class="title"> Slideshow </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.photo.index',['type'=>'banner']) }}" data-route="photo.banner" class="nav-link ">
                            <span class="title"> Banner </span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{ route('admin.photo.index',['type'=>'bank']) }}" data-route="photo.bank" class="nav-link ">
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    <li class="nav-item">
                        <a href="{{ route('admin.link.index',['type'=>'tieu-chi']) }}" data-route="link.tieu-chi" class="nav-link ">
                            <span class="title"> Tiêu chí </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.link.index',['type'=>'social']) }}" data-route="link.social" class="nav-link ">
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    <li class="nav-item">
                        <a href="{{ route('admin.register.index',['type'=>'newsletter']) }}" data-route="register.newsletter" class="nav-link ">
                            <span class="title"> Bản tin </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.register.index',['type'=>'contact']) }}" data-route="register.contact" class="nav-link ">
                            <span class="title"> Liên hệ </span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="nav-item">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.user.index') }}" data-route="user" class="nav-link">

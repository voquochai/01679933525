...
@section('breadcrumb')
<li>
    <a href="{{ route('wms_store.index', ['type'=>$type]) }}"> {{ $pageTitle }} </a>
...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="{{ route('wms_store.update',['id'=>$item->id,'type'=>$type]) }}" >
        {{ csrf_field() }}
        {{ method_field('put') }}
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[code]" class="form-control" value="{{ $item->code }}">
                        </div>
                    </div>

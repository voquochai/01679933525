...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="{{ route('product.update',['id'=>$item->id,'type'=>$type]) }}" enctype="multipart/form-data" >
        {{ csrf_field() }}
        {{ method_field('put') }}
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select name="colors[]" class="selectpicker show-tick show-menu-arrow form-control" multiple>
                                ...
                                <option value="{{ $color->id }}" {{ ( in_array($color->id,$item->getIdAttributes('product_colors')) ) ? 'selected' : '' }} > {{ $color->title }} </option>
                                @empty
                                @endforelse
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select name="sizes[]" class="selectpicker show-tick show-menu-arrow form-control" multiple>
                                ...
                                <option value="{{ $size->id }}" {{ ( in_array($size->id,$item->getIdAttributes('product_sizes')) ) ? 'selected' : '' }} > {{ $size->title }} </option>
                                @empty
                                @endforelse
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select name="tags[]" class="selectpicker show-tick show-menu-arrow form-control" multiple>
                                @forelse($tags as $tag)
                                <option value="{{ $tag->id }}" {{ ( in_array($tag->id,$item->getIdAttributes('product_tags')) ) ? 'selected' : '' }} > {{ $tag->title }} </option>
                                @empty
                                @endforelse
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[code]" value="{{ $item->code }}" class="form-control">
                        </div>
                    </div>

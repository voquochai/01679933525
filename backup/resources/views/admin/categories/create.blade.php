...
@section('breadcrumb')
<li>
    <a href="{{ route('category.index', ['type'=>$type]) }}"> {{$pageTitle}} </a>
...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="{{ route('category.store',['type'=>$type]) }}" enctype="multipart/form-data" >
        {{ csrf_field() }}
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="dataL[vi][slug]" class="form-control slug" value="{{ old('dataL.'.$key.'.slug') }}">
                        </div>
                    </div>

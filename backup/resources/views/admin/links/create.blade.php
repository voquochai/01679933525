...
@section('breadcrumb')
<li>
    <a href="{{ route('link.index', ['type'=>$type]) }}"> {{ $pageTitle }} </a>
...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="{{ route('link.store',['type'=>$type]) }}" enctype="multipart/form-data" >
        {{ csrf_field() }}
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[facebook]" class="form-control" value="{{ old('data.facebook') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[skype]" class="form-control" value="{{ old('data.skype') }}">
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[youtube]" class="form-control" value="{{ old('data.youtube') }}">
                        </div>
                    </div>
                    @endif

...
class PostController extends Controller
{
    ...
    public function create(){
        ...
        $this->_data['tags'] = $this->getAttribute('post_tags');
    ...
    public function store(Request $request){
        ...
        if ($valid->fails()) {
            ...
            return redirect()->route('post.index',['type'=>$this->_data['type']])->with('success','Thêm dữ liệu <b>'.$post->languages[0]->title.'</b> thành công');
        }
    ...
    public function edit($id){
        ...
        return redirect()->route('post.index',['type'=>$this->_data['type']])->with('danger', 'Dữ liệu không tồn tại');
    }
    ...
    public function delete($id){
        ...
        if ($post !== null) {
            ...
            if( $post->delete() ){
                return redirect()->route('post.index',['type'=>$this->_data['type']])->with('success', 'Xóa dữ liệu <b>'.$deleted.'</b> thành công');
            }else{
                return redirect()->route('post.index',['type'=>$this->_data['type']])->with('danger', 'Xóa dữ liệu bị lỗi');
            }
        }
        return redirect()->route('post.index',['type'=>$this->_data['type']])->with('danger', 'Dữ liệu không tồn tại');
    }
